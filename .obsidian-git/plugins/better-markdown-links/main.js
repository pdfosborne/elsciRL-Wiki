  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileSystem.cjs"(exports2, module2) {
    ...
    function getMarkdownFiles(app, pathOrFolder, isRecursive) {
      ...
      if (!isRecursive) {
        ...
        import_obsidian4.Vault.recurseChildren(folder, (abstractFile) => {
    ...
    function isAbstractFile(file) {
      return file instanceof import_obsidian4.TAbstractFile;
    }
    ...
    function isFolder(file) {
      return file instanceof import_obsidian4.TFolder;
    }
    ...
    function getResolvedPath(path) {
      return (0, import_obsidian4.normalizePath)((0, import_Path.resolve)("/", path));
    }
  }
});
...
var require_Frontmatter = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Frontmatter.cjs"(exports2, module2) {
    ...
    function parseFrontmatter(content3) {
      const frontmatterInfo = (0, import_obsidian4.getFrontMatterInfo)(content3);
      return (0, import_obsidian4.parseYaml)(frontmatterInfo.frontmatter) ?? {};
    }
    function setFrontmatter(content3, newFrontmatter) {
      ...
      const newFrontmatterStr = (0, import_obsidian4.stringifyYaml)(newFrontmatter);
...
var require_Vault = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Vault.cjs"(exports2, module2) {
    ...
    async function invokeFileActionSafe(app, pathOrFile, fileAction) {
      const path = (0, import_FileSystem3.getPath)(app, pathOrFile);
      const file = (0, import_FileSystem3.getFileOrNull)(app, path);
      ...
      try {
        ...
        const file2 = (0, import_FileSystem3.getFileOrNull)(app, path);
...
var require_FileChange = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileChange.cjs"(exports2, module2) {
    ...
    async function applyFileChanges2(app, pathOrFile, changesProvider, processOptions = {}) {
      await (0, import_Vault2.process)(app, pathOrFile, async (content3) => {
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/MetadataCache.cjs"(exports2, module2) {
    ...
    async function getBacklinksForFileSafe(app, pathOrFile, retryOptions = {}) {
      ...
      await (0, import_Async.retryWithTimeout)(async () => {
        ...
        for (const notePath of backlinks.keys()) {
          ...
          const content3 = await (0, import_Vault2.readSafe)(app, note);
          if (!content3) {
            return false;
          }
    ...
    async function saveNote(app, pathOrFile) {
      ...
      for (const leaf of app.workspace.getLeavesOfType("markdown")) {
        if (leaf.view instanceof import_obsidian4.MarkdownView && leaf.view.file?.path === path) {
...
var require_Link = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Link.cjs"(exports2, module2) {
    ...
    function extractLinkFile(app, link2, sourcePathOrFile) {
      const { linkPath } = splitSubpath2(link2.link);
    ...
    function generateMarkdownLink2(options) {
      ...
      return (0, import_MetadataCache2.tempRegisterFileAndRun)(app, targetFile, () => {
        ...
        const shouldForceRelativePath = options.shouldForceRelativePath ?? (0, import_ObsidianSettings3.shouldUseRelativeLinks)(app);
    ...
    function shouldResetAlias(options) {
      ...
      const targetFile = (0, import_FileSystem3.getFile)(app, targetPathOrFile, true);
      ...
      const cleanDisplayText = (0, import_obsidian4.normalizePath)(displayText.split(" > ")[0] ?? "").replace(/^\.\//, "").toLowerCase();
    ...
    function splitSubpath2(link2) {
      const parsed = (0, import_obsidian4.parseLinktext)((0, import_String.normalize)(link2));
      return {
    ...
    function updateLink(options) {
      ...
      const targetFile = (0, import_FileSystem3.getFile)(app, newTargetPathOrFile, true);
      ...
      const { subpath } = splitSubpath2(link2.link);
    ...
    async function updateLinksInFile2(options) {
      ...
      await editLinks(app, newSourcePathOrFile, (link2) => {
        ...
        return convertLink2((0, import_Object2.normalizeOptionalProperties)({
          app,
          link: link2,
          newSourcePathOrFile,
          oldSourcePathOrFile,
...
var require_PluginBase = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Plugin/PluginBase.cjs"(exports2, module2) {
    ...
    var PluginBase2 = class extends import_obsidian4.Plugin {
      /**
      ...
      showNotice(message) {
        ...
        this.notice = new import_obsidian4.Notice(`${this.manifest.name}
${message}`);
      }
      /**
...
var require_AttachmentPath = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/AttachmentPath.cjs"(exports2, module2) {
    ...
    async function getAttachmentFilePath(app, attachmentPathOrFile, notePathOrFile) {
      const attachmentPath = (0, import_FileSystem3.getPath)(app, attachmentPathOrFile);
      const notePath = (0, import_FileSystem3.getPath)(app, notePathOrFile);
...
var require_VaultEx = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/VaultEx.cjs"(exports2, module2) {
    ...
    async function deleteEmptyFolderHierarchy(app, pathOrFolder) {
      ...
      while (folder) {
        if (!await (0, import_Vault2.isEmptyFolder)(app, folder)) {
          return;
        }
    ...
    async function deleteSafe(app, pathOrFile, deletedNotePath, shouldReportUsedAttachments, shouldDeleteEmptyFolders) {
      ...
      if ((0, import_FileSystem3.isFile)(file)) {
        ...
        const listedFiles = await (0, import_Vault2.listSafe)(app, file);
        ...
        canDelete &&= await (0, import_Vault2.isEmptyFolder)(app, file);
      }
      if (canDelete) {
        try {
          await app.fileManager.trashFile(file);
...
var require_RenameDeleteHandler = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/RenameDeleteHandler.cjs"(exports2, module2) {
    ...
    var import_monkey_around2 = require_dist2();
    var import_obsidian4 = require("obsidian");
    var import_Function2 = require_Function();
    var import_Object2 = require_Object();
    var import_Path = require_Path();
    ...
    var import_Vault2 = require_Vault();
    var import_VaultEx = require_VaultEx();
    ...
    async function fillRenameMap(app, oldPath, newPath, renameMap, oldPathLinks) {
      ...
      if (!(0, import_FileSystem3.isNote)(app, oldPath)) {
        return;
      }
      ...
      if (!await (0, import_AttachmentPath.hasOwnAttachmentFolder)(app, oldPath)) {
        for (const oldPathLink of oldPathLinks) {
          const oldAttachmentFile = (0, import_Link4.extractLinkFile)(app, oldPathLink, oldPath);
        ...
        import_obsidian4.Vault.recurseChildren(oldAttachmentFolder, (oldAttachmentFile) => {
      ...
      for (const oldAttachmentFile of oldAttachmentFiles) {
        if ((0, import_FileSystem3.isNote)(app, oldAttachmentFile)) {
          continue;
        }
    ...
    async function handleDelete(app, path) {
      ...
      if (!(0, import_FileSystem3.isNote)(app, path)) {
        return;
      }
      const settings = getSettings(app);
      ...
      if (cache) {
        ...
        for (const link2 of links) {
          const attachmentFile = (0, import_Link4.extractLinkFile)(app, link2, path);
          if (!attachmentFile) {
            continue;
          }
          if ((0, import_FileSystem3.isNote)(app, attachmentFile)) {
            continue;
          }
    ...
    function handleMetadataDeleted(app, file, prevCache) {
      ...
      if ((0, import_FileSystem3.isMarkdownFile)(app, file) && prevCache) {
    ...
    function handleRename(app, oldPath, newPath) {
      ...
      (0, import_Queue3.addToQueue)(app, () => handleRenameAsync(app, oldPath, newPath, oldPathBacklinksMap, oldPathLinks));
    }
    async function handleRenameAsync(app, oldPath, newPath, oldPathBacklinksMap, oldPathLinks, interruptedCombinedBacklinksMap) {
      ...
      try {
        ...
        for (const [newBacklinkPath, linkJsonToPathMap] of Array.from(combinedBacklinksMap.entries()).concat(Array.from(interruptedCombinedBacklinksMap?.entries() ?? []))) {
          await (0, import_Link4.editLinks)(app, newBacklinkPath, (link2) => {
            ...
            return (0, import_Link4.updateLink)((0, import_Object2.normalizeOptionalProperties)({
              app,
              link: link2,
        ...
        if ((0, import_FileSystem3.isNote)(app, newPath)) {
          await (0, import_Link4.updateLinksInFile)((0, import_Object2.normalizeOptionalProperties)({
            app,
        ...
        if (!(0, import_FileSystem3.getFileOrNull)(app, newPath)) {
...
var require_PluginSettingsTabBase = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Plugin/PluginSettingsTabBase.cjs"(exports2, module2) {
    ...
    var PluginSettingsTabBase2 = class extends import_obsidian4.PluginSettingTab {
      constructor(plugin) {
...
var require_ValueComponent = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Plugin/ValueComponent.cjs"(exports2, module2) {
    ...
    function getValidatorElement(valueComponent) {
      if (valueComponent instanceof import_obsidian4.DropdownComponent) {
        return valueComponent.selectEl;
      }
      if (valueComponent instanceof import_obsidian4.SliderComponent) {
        return valueComponent.sliderEl;
      }
      if (valueComponent instanceof import_obsidian4.TextAreaComponent) {
        return valueComponent.inputEl;
      }
      if (valueComponent instanceof import_obsidian4.TextComponent) {
        return valueComponent.inputEl;
      }
      return null;
    }
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Modal/Confirm.cjs"(exports2, module2) {
    ...
    var ConfirmModal = class extends import_obsidian4.Modal {
      ...
      onOpen() {
        ...
        const okButton = new import_obsidian4.ButtonComponent(this.contentEl);
        ...
        const cancelButton = new import_obsidian4.ButtonComponent(this.contentEl);
...
var BetterMarkdownLinksPluginSettings = class extends import_PluginSettingsBase.PluginSettingsBase {
...
function generateMarkdownLinkForPlugin(plugin, fileOrOptions, sourcePath, subpath, alias) {
  ...
  if (fileOrOptions instanceof import_obsidian2.TFile) {
    options = (0, import_Object.normalizeOptionalProperties)({
      alias,
...
function getDefaultOptions(plugin) {
  ...
  return (0, import_Object.normalizeOptionalProperties)({
    ...
    shouldForceRelativePath: pluginSettings.ignoreIncompatibleObsidianSettings ? true : void 0,
...
async function applyLinkChangeUpdates(plugin, file, updates) {
  await (0, import_FileChange.applyFileChanges)(plugin.app, file, async () => {
    ...
    const content3 = await plugin.app.vault.read(file);
    const doUpdatesMatchContent = changes.every((change) => content3.slice(change.startIndex, change.endIndex) === change.oldContent);
    return doUpdatesMatchContent ? changes : [];
  });
}
function convertLinksInCurrentFile(plugin, checking) {
  const activeFile = plugin.app.workspace.getActiveFile();
  if (!activeFile || !(0, import_FileSystem.isMarkdownFile)(plugin.app, activeFile)) {
    return false;
  }
  if (!checking) {
    (0, import_Queue.addToQueue)(plugin.app, () => convertLinksInFile(plugin, activeFile, true));
  }
  return true;
}
async function convertLinksInEntireVault(plugin, abortSignal) {
  ...
  await (0, import_Loop.loop)({
    ...
    items: (0, import_Vault.getMarkdownFilesSorted)(plugin.app),
...
async function convertLinksInFile(plugin, file, shouldPromptForExcludedFile) {
  if (!checkObsidianSettingsCompatibility(plugin)) {
    return;
  }
  if (plugin.settingsCopy.isPathIgnored(file.path)) {
    ...
    const shouldConvert = await (0, import_Confirm.confirm)({ app: plugin.app, message: `Note '${file.path}' is excluded from the conversion in plugin settings. Do you want to convert it anyway?` });
    if (!shouldConvert) {
      return;
    }
  }
...
function fixChange(plugin, change, sourceFile) {
...
var BetterMarkdownLinksPlugin = class extends import_PluginBase.PluginBase {
  ...
  showCompatibilityWarning() {
    ...
    if (this.warningNotice.noticeEl.style.opacity === "0") {
      this.warningNotice = new import_obsidian3.Notice(message, 1e4);
    }
  }
  ...
  onloadComplete() {
    ...
    this.warningNotice = new import_obsidian3.Notice("");
    ...
    this.app.fileManager.linkUpdaters[import_FileSystem2.MARKDOWN_FILE_EXTENSION] = {
      ...
      iterateReferences: import_Function.noop,
      renameSubpath: import_Function.noopAsync
    };
    this.register(() => {
  ...
  async handleMetadataCacheChanged(file) {
    ...
    if (links.some((link2) => link2.original !== (0, import_Link3.convertLink)({
      app: this.app,
      link: link2,
      newSourcePathOrFile: file
    }))) {
